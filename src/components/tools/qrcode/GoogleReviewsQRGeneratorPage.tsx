...
const GoogleReviewsQRGeneratorPage = () => {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-white to-primary-100 pb-16">      
      <div className="container py-8 flex-1">
        ...
        <div className="mt-16 max-w-2xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="p-4">
              <div className="w-12 h-12 bg-primary-100 text-primary-800 rounded-full flex items-center justify-center mx-auto mb-3">
              ...
              <p className="text-sm text-muted-foreground">Enter your business name and Google Place ID to create a custom QR code</p>
            </div>
            <div className="p-4">
              <div className="w-12 h-12 bg-primary-100 text-primary-800 rounded-full flex items-center justify-center mx-auto mb-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
